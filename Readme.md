...
I'm currently in the process of importing some of my coding exercises that I've been playing with. I was starting to open new projects and work with them standalone. However, short of creating new repositories for each of them, I felt they were all new tools that belonged in the garage.

So, I'm adding them in as new classes, as in "in this class, we will learn the following topics. See, it's like a play on words, so even better. 

Check out [Homework.md](/Homework.md) for a running list of what's been imported and what's to come.
